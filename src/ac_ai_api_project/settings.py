"""
Django settings for ac_ai_api project.
...
ROOT_URLCONF = 'ac_ai_api_project.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'ac_ai_api_project', 'templates'), ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ac_ai_api_project.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'ac_ai_api_project', 'static')
]
